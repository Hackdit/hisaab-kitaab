...
-- Seed data for HSN codes and GST rates (top MSME products)
...
-- Sample customers
INSERT INTO customers (business_id, name, whatsapp_number, total_outstanding)
SELECT id, 'Ramesh Kumar', '+919876543211', 2500.00 FROM businesses WHERE whatsapp_number = '+919876543210'
UNION ALL
SELECT id, 'Sita Devi', '+919876543212', 1800.00 FROM businesses WHERE whatsapp_number = '+919876543210'
UNION ALL
SELECT id, 'John Doe', '+918765432110', 3200.00 FROM businesses WHERE whatsapp_number = '+918765432109'
UNION ALL
SELECT id, 'Priya Sharma', '+918765432111', 1500.00 FROM businesses WHERE whatsapp_number = '+918765432109';